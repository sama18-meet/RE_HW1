...
LFB13:
	...
	mov	DWORD PTR [esp+100], 0 # putchar_ptr
                        ...
                        mov     DWORD PTR [ebp+120], eax # initialize get_proc_addr_ptr
                        ...
                        mov     DWORD PTR [ebp+104], eax # initialize printf_ptr
                        ...
                        mov eax, DWORD PTR [ebp+120] # get_proc_addr_ptr
                        call eax            # call GetProcAddress(msvcrt, "strcmp")
                        add esp, 0x08       # clear stack (note arguments are cleared already)
                        mov     DWORD PTR [ebp+108], eax # initialize strcmp_ptr
                        ...
                        call eax            # call GetProcAddress(msvcrt, "strcmp")
                        add esp, 0x08       # clear stack (note arguments are cleared already)
                        mov     DWORD PTR [ebp+116], eax # initialize strcspn_ptr
                        ...
                        call eax            # call GetProcAddress(msvcrt, "strcmp")
                        add esp, 0x08       # clear stack (note arguments are cleared already)
                        mov     DWORD PTR [ebp+112], eax # initialize fgets_ptr
                        ...
                        call eax            # call GetProcAddress(msvcrt, "strcmp")
                        add esp, 0x08       # clear stack (note arguments are cleared already)
                        mov     DWORD PTR [ebp+100], eax # initialize putchar
